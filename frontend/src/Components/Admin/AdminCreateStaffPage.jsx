...
import farmcartLogo from '../../assets/logo.png'; // Adjust the path to your logo image
...
const AdminCreateStaffPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[radial-gradient(100%_50%_at_50%_0%,#b8f724_0,#faffe5_50%,rgba(0,163,255,0)_100%)]"> {/* Set background gradient */}
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-lg border-2 border-green-600">
        <div className="text-left mb-5 text-center"> {/* Center logo */}
          <img
            src={farmcartLogo}
            alt="FarmCart Logo"
            className="h-7 w-auto mb-4 mx-auto" // Adjust the size and margins as needed
          />
          <h2 className="text-2xl font-bold">{editMode ? 'Edit Staff Member' : 'Add Staff Member'}</h2>
        </div>
